...
@Component({
    ...
    templateUrl: './historyhandover-modal.component.html',
    styleUrls: ['./historyhandover-modal.component.scss']
})
export class HistoryHandoverModalComponent implements OnInit {
