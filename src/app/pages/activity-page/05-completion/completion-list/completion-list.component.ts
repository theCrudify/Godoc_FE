...
// Import components
import { ApprovalCompletionComponent } from './modal/approval/completionapproval-modal.component';
import { HistoryCompletionModalComponent } from './modal/history/completionhandover-modal.component';
...
export class completionListComponent implements OnInit, OnDestroy {
    ...
    loadedProposedChanges(): void {
        ...
        const url = `/completion?auth_id=${this.GodocUser.auth_id}&page=${this.page}&limit=${this.pageSize}&search=${this.searchTerm}&sort=${this.sortColumn}&direction=${this.sortDirection}`;
