...
@Component({
    ...
    templateUrl: './historycompletion-modal.component.html',
    styleUrls: ['./historycompletion-modal.component.scss']
})
export class HistoryCompletionModalComponent implements OnInit {
    ...
    loadHistoryData(): void {
        ...
        this.service.get(`/history-byID-handover/${this.id}`).pipe(
