...
import { ApprovalModalComponent } from '../list/modal/approval/approval-modal.component';
import { HistoryModalComponent } from '../list/modal/history/history-modal.component';
...
export class AdminProposedChangesListComponent implements OnInit, OnDestroy {
...
pendingRequestsCount: any;
    ...
    ngOnInit(): void {
        ...
        if (roleName === 'Admin' || roleName === 'Super Admin') {
            this.titlePrefix = roleName; // Bisa juga kasih format lainnya
